...
As I only have need for a subset of the functionality. I made the electric bike motor controller works with an Arduino. However there are so many customization.
I made two electric bike motors work using its own controller and an Arduino.

The other hand, I added my own encoder configuration also and its defined differently.
